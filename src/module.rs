...
pub mod builtins {
    ...
    impl ModuleType for Const {
        ...
        const ICON: Icon = icons::CONST_GEN;
...
/// Built-in module icons (32×32 monochrome; see [`Icon`]). The bit-art is generated;
/// each row is a `0b…` literal reading left-to-right, top row first.
pub mod icons {
    use super::Icon;

    pub const CONST_GEN: Icon = [
    ...
    pub const AUDIO_OUTPUT: Icon = [
        ...
        0b00000000000000000000000000000000,
        0b00000000000000001100000000000000,
        0b00000000000000011100000100000000,
        0b00000000000001111100000100000000,
        0b00000000000011111101000010000000,
        0b00000000000111001101000010000000,
        0b00000011111111111100100001000000,
        0b00000011111111111100100001000000,
        0b00000011111111111100010000100000,
        0b00000011111111111100010000100000,
        0b00000011111111111100010000100000,
        0b00000011111111111100100001000000,
        0b00000000001110001100100001000000,
        0b00000000000111001101000010000000,
        0b00000000000011111101000010000000,
        0b00000000000001111100000100000000,
        0b00000000000000011100000100000000,
    ...
    pub const UNKNOWN: Icon = [
        ...
        0b00000001000000000000000010000000,
        0b00000001000000000000000010000000,
        0b00000001000001111111000010000000,
        0b00000001000001111111000010000000,
        0b00000001000000000011000010000000,
        0b00000001000000000011000010000000,
        0b00000001000000000011000010000000,
        0b00000001000000001111000010000000,
        0b00000001000000011110000010000000,
        0b00000001000000011000000010000000,
        0b00000001000000011000000010000000,
        0b00000001000000011000000010000000,
        0b00000001000000000000000010000000,
        0b00000001000000111000000010000000,
        0b00000001000000111000000010000000,
        0b00000001000000111000000010000000,
        0b00000001000000000000000010000000,
        0b00000001000000000000000010000000,
